...
?>
          <tr>
            ...
            <td><?php print $products_price ?> EUR</td>
            <td><?php print $proizvod[1] ?></td>
            <td><?php print $products_pricesubtotal ?> EUR</td>
          </tr>
<?php
					}
				}
...
?>
	  ...
	  <div style="text-align:right;font-weight:bold;margin-bottom:5px">Ukupno: <?php print number_format($products_pricetotal, 2, ',', ' '); ?> EUR</div>
